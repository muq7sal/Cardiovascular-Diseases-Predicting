# Machine Learning Approaches for Predicting Cardiovascular Diseases
# Project Description:
The proposed project focuses on developing a Machine Learning–based Cardiovascular Disease (CVD) Prediction System that can identify individuals at high risk using medical and lifestyle attributes.
To build this system, the following steps are followed:
1. Retrieve the cardiovascular dataset from Google Drive.
2. Apply data pre-processing (cleaning, feature importance, standardization).
3. Use Fuzzy C-Means clustering to handle data imbalance and improve model performance.
4. Split the dataset into 75% training and 25% testing sets.
